...
const itemsMap = new Map([
  ...
  [97077, {mainName: "Aurene's Wing", altNames: ['LS','ls', 'Ala de Aurene', 'Wing', 'Arco Corto'] }],
  ...
  [97590, {mainName: "Aurene's Flight", altNames: ['LB', 'lb', 'Vuelo de Aurene','Flight', 'longbow'] }],
  ...
  [85016, {mainName: 'Blue', altNames: ['blue', 'Piece of Common Unidentified Gear','Pieza de equipo común sin identificar'] }],
  [84731, {mainName: 'Green', altNames: ['green', 'Piece of Unidentified Gear', 'Pieza de equipo sin identificar'] }],
  [83008, {mainName: 'Yellow', altNames: ['yellow', 'Piece of Rare Unidentified Gear', 'Pieza de equipo excepcional sin identificar']}],
